        ...
        <div class="content-bg">
	        <div class="content">
              ...
              <div class="title"><h1><?php echo $entry[0]->title; ?></h1></div>
                ...
                <?php if($author){?></>Postavio: <a href="#"><?php echo $author; ?></a><span class="separator">&nbsp;</span><?php } ?><?php echo srb_date($entry[0]->creation_date); ?>
                ...
                <div class="subcontent">
                  <div>
                  <?php echo modules::run('tags/list_tags', array("entry_id" => $entry[0]->id)); ?>
                  </div>
              ...
              <div class="column-right">
                  ...
                  <h3>Vesti</h3>
                  <div class="box-inside"> <a href="#"><img src="images/temp-v.jpg" alt="Izlazak LEGO Star Wars 3: The Clone Wars odloÅ¾en za 22. mart" width="385" height="210" /></a>
				  <h4><a href="#">Izlazak LEGO Star Wars 3: The Clone Wars odloÅ¾en za 22. mart</a></h4>
                  <p>OÄ�igledno, LucasArts treba  malo viÅ¡e vremena nego Å¡to je predviÄ‘eno da se adekvatno pripremi LEGO Star Wars 3: The Clone Wars - Izlazak je pomeren sa 15. februara na 22. mart.</p>
                  ...
                  <div class="box-classic-bottom">
                  	<div class="left"><a href="#">JoÅ¡^</a><span class="separator-small">&nbsp;</span></div>
                  	<div class="clear"></div>
                  </div>
                  </div>
              </div><!--end box classic-->
...
<div class="box-classic">
          ...
          <div class="box-bottom">
                  	<div class="left"><a href="#"></a><span class="separator-small">&nbsp;</span></div>
                    <div class="right"><span class="separator-small">&nbsp;</span><a href="#">25 komentara</a></div>
                    <div class="clear"></div>
                </div>
              </div>
   	  ...
   	  <div class="left">
                    ...
                    <div class="right">
                    	<h2>PoÅ¡alji nam i ti link sa smeÅ¡nim videom!</h2>
                        <p>Ukoliko Å¾elite da podelite smeÅ¡an video sa ostalima, unesite njegov URL u predviÄ‘eno polje i kliknite na PoÅ¡alji!
                        
                        </p>
                   	  <label>YouTube URL:*</label><br />
                   	  <input class="entryfield" name="" type="text" /><br />
					  <input class="button" name="" type="submit" value="PoÅ¡alji!" /><br />
						<span>*Trenutno podrÅ¾avamo linkove samo sa <a href="http://www.youtube.com/" target="_blank">YouTube</a> video servisa. <br />
					  ProGame.rs zadrÅ¾ava pravo da ne objavi ili ukloni linkove bez ikakvog objaÅ¡njenja.</span>                        
                  </div>
                    <div class="clear"></div>
        	...
        	<div class="finish">
            &copy;2011 ProGame.rs. Sva prava zadrÅ¾ana.
