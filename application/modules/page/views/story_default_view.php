        ...
        <div class="content-bg">
	        <div class="content">
              ...
              <div class="title"><h1><?php echo $entry[0]->title; ?></h1></div>
                ...
                Postavio: <a href="#"><?php echo $author; ?></a><span class="separator">&nbsp;</span><?php echo $entry[0]->creation_date; ?><span class="separator">&nbsp;</span><a href="#">Vesti</a><span class="separator">&nbsp;</span><a href="#">90 komentara</a>
                </div>
