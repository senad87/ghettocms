...
<div class="<?php if(isset($module_params['classsuffix']) && $module_params['classsuffix'] != "") echo $module_params['classsuffix']; ?>">
	...
	<?php if($module_params['poster_photo'] == 1){?>
	     <img src="<?php echo base_url(); ?><?php echo $thumb_image_path; ?>" title="<?php echo $story[0]->title; ?>" alt="<?php echo $story[0]->title; ?>" />
	<?php } ?>
	</div>         
	<div class="news-block">  
	<?php if($module_params['title'] == 1){?>
	<div class="title"><h1><?php echo $story[0]->title; ?> </h1></div>
	<?php } ?>
	<div class="news-block-info">
	<?php if($module_params['creation_date'] == 1){ ?>
	<div class="date"><?php echo $story[0]->creation_date; ?></div>
	<?php } ?>
    </div>
