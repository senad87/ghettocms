...
<link href="<?php echo base_url();?>application/views/css/global.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="<?php echo base_url();?>application/views/js/jquery-1.4.4.min.js"></script>
<script type="text/javascript"
	src="<?php echo base_url();?>application/views/js/jquery.idTabs.min.js"></script>
</head>
<body>
...
<div class="content">
<div class="header">
<div class="logo"><a href="index1.php"><img
	src="<?php echo base_url();?>application/views/images/logo.png"
	alt="ProGame.rs" title="ProGame.rs" width="260" height="110" /></a></div>
<div class="banner-top"><a href="#"><img
	src="<?php echo base_url();?>application/views/images/temp728x90.jpg"
	alt="Banner" width="728" height="90" /></a></div>
<div class="clear"></div>
</div>
<div class="menu-bg"><?php 
//print_r($from_menu_id);
echo modules::run('position', 1, $from_menu_id); ?></div>
...
<div id="tag_list">
	...
	<h2><a
		href="<?php echo base_url(); ?><?php echo $story['type_name']; ?>/<?php echo $from_menu_id; ?>/<?php echo $story['id']; ?>/<?php echo url_title($story['title']); ?>"><span><?php echo $story['title']; ?></span></a></h2>
	</div>
...
<div class="box-classic"><?php echo modules::run('position', 3, $from_menu_id); ?>
</div>
<!--end box classic-->
<div class="box-banner"><a href="#"><img src="images/temp300x250.jpg"
	alt="EVE Online" width="300" height="250" /></a></div>
<!--end box banner-->
...
<p class="item"><a href="#"><img src="images/temp-pes.jpg"
	alt="Demo: Pro Evolution Soccer 2011" width="140" height="87" /></a>This
updated demo includes major changes to team stacking, bug fixes and
more.</p>
<div class="clear"></div>
<h5><a href="#">Football Manager 2011 Strawberry</a></h5>
<p class="item"><a href="#"><img src="images/temp-fm2011.jpg"
	alt="Demo: Football Manager 2011 Strawberry" width="140" height="87" /></a>This
updated demo includes major changes to team stacking, bug fixes and
more.</p>
<div class="clear"></div>
...
<ul class="toplist">
	...
	<li class="odd"><a href="#"><span>10</span>Star Wars: The Force
	Unleashed II</a></li>
</ul>
<div class="box-toplist-bottom">
<div class="left"><a href="#">Još^</a><span class="separator-small">&nbsp;</span>
</div>
<div class="right"><span class="separator-small">&nbsp;</span><a
	href="#">25 komentara</a></div>
<div class="clear"></div>
</div>
</div>
<!-- end of div-box-tab-list -->
<div id="top10godina">
<ul class="toplist">
	<li><a href="#"><span>1</span>Starcraft II: Wings of Liberty</a></li>
	<li class="odd"><a href="#"><span>2</span>Star Wars: The Force
	Unleashed II</a></li>
...
<div class="box-classic">
<h3>HOT GAME</h3>
<div class="foto"><a href="#"><img src="images/temp-foto.jpg" alt="Foto"
	width="300" height="350" /></a></div>
...
<div class="left"><iframe title="YouTube video player" width="640"
	height="390" src="http://www.youtube.com/embed/t5c_MYLDV-w"
	frameborder="0" allowfullscreen></iframe></div>
<div class="right">
<h2>Pošalji nam i ti link sa smešnim videom!</h2>
<p>Ukoliko želite da podelite smešan video sa ostalima, unesite njegov
URL u predviđeno polje i kliknite na Pošalji!</p>
<label>YouTube URL:*</label><br />
<input class="entryfield" name="" type="text" /><br />
<input class="button" name="" type="submit" value="Pošalji!" /><br />
<span>*Trenutno podržavamo linkove samo sa <a
	href="http://www.youtube.com/" target="_blank">YouTube</a> video
servisa. <br />
ProGame.rs zadržava pravo da ne objavi ili ukloni linkove bez ikakvog
objašnjenja.</span></div>
<div class="clear"></div>
...
<div class="bottom-menu"><a href="#"><img src="images/foot-pg.png"
...
<div class="finish">&copy;2011 ProGame.rs. Sva prava zadržana.</div>
</div>
