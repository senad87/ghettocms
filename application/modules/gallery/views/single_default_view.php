...
<meta name="description" content="<?php echo $item->title; ?>" />
<meta property="fb:app_id" content="602203836462577">
<meta property="og:type" content="article"/>
<meta property="og:title" content="<?php echo $item->title; ?>"/>
<meta property="og:image" content="<?php echo base_url(); ?><?php echo $item->images[0]->path; ?>"/>
...
<?php } ?>    
	               ...
	               <!-- <img src="<?php echo base_url(); ?><?php echo $item->images[0]->path; ?>" title="<?php echo $item->title; ?>" alt="<?php echo $item->title; ?>" width="660" height="410" /> -->
                </div>
		...
		<div class="clear"></div>          
               ...
               <!-- share end -->
                  ...
                  <?php if($cat_comment_status == 1 && $entry_comment_status == 1){?>
				       <?php echo modules::run('comments', array($from_menu_id, $item->id, $post)); ?>  
                    <?php } ?>
                  <div class="clear"></div>
                </div>
              </div>
