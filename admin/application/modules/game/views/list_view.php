...
<div id="system_topics">
  <?php echo modules::run('topic/selectSystem', 2); ?>
</div>
</div>
</div>
</div>
...
<div class="left-panel">
	<?php echo modules::run('table', $entries, array('input|false|false|checkbox', 'text_link|title|Game Name', 'text|creation_date|Created', 'text|modified_date|Modified', 'text|category|Category', 'text|state|Status', 'text|type_id|ID'), 'game'); ?>
</div>
