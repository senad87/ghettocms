...
<?php echo modules::run('table', $entries, array('input|false|false|checkbox', 'text_link|title|Title', 'text|creation_date|Created', 'text|modified_date|Modified', 'text|category|Category', 'text|state|Status', 'text|type_id|ID'), 'story'); ?>
</div>
