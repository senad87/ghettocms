...
class Category_model extends CI_Model {
	...
	public function insert_new_category($parent_id, $name, $menu_id, $description = "", $language_id = 1){
	...
	public function update_category_data($id, $name, $menu_id, $parent_id, $description){
		...
		$data = array("name" => $name, "parent_id"=>$parent_id, "menu_id"=>$menu_id, "description" => $description);
		$this->db->where('id', $id);
