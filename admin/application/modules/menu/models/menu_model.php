...
class Menu_model extends CI_Model {
	...
	/**
	 * Return list of all menu with given menu state id
	 * @param int $state
	 * @return array array of objects
	 */
	public function getMenusByState($state, $language_id = 1){
		$query = $this->db->get_where("menus", array("menu_state_id" => $state, "language_id" => $language_id));
		return $query->result();	
	}
