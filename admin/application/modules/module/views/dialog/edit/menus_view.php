<table class="data" border="0" cellpadding="0" cellspacing="0">
		...
		foreach ($root_menus as $menu) { ?>
			...
			<td align="center"><input type="radio" name="menus_id" class="radio_category_id" value="<?php echo $menu->id; ?>" <?php if($menu->id == $module_params['menus_id']){?>checked="checked"<?php } ?>></td><td align="left"><?php echo $menu->name; ?></td>
			</tr>
		<?php } ?>
		<tfoot>
			<tr>
