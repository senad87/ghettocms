...
class MYJquery_pagination extends Jquery_pagination {
	 ...
	 * @param string $per_page
         * @param string $divcontainer  Here #content is the CSS selector for target DIV
	 */
	public function load_pagination($pagination_url, $uri_segments, $total_rows, $per_page, $divcontainer = "#content" ){
                $config['uri_segment'] = $uri_segments;
                    ...
                    $config['div'] = $divcontainer; /* Here #content is the CSS selector for target DIV */
