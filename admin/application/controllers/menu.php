...
class Menu extends CI_Controller {
	...
	public function index($message = ""){
        ...
        $this->load->view('menus/menus_home_view', $data);  
	}
	...
	public function new_menu(){
        ...
        $this->load->view("header_view");
        $this->load->view('menus/new_menu_form_view');  
	}
	...
	public function edit($id){
		...
		$data['menu'] = $menu[0];
		$this->load->view("header_view");
        $this->load->view('menus/edit_menu_form_view', $data); 
	}
	...
	public function edit_item($root_parent_id, $id){
		...
		$this->load->view("header_view");
        $this->load->view('menus/edit_menu_item_form_view', $data); 
	...
	public function items_list($parent_id){
		...
		$this->load->view('header_view');
        $this->load->view('menus/menu_items_list_view', $data);
	...
	public function select_template($menu_id){
		...
		$this->load->view('header_view');
        $this->load->view('menus/select_template_view', $data);
	}
	...
	public function create_layout($menu_id){
		...
		$data['templates'] = $this->Template_model->get_templates_by_state(1);
		$this->load->view('header_view');
        $this->load->view('menus/layout_view', $data);
	}
	...
	public function delete($root_menu_id, $id){
	...
	public function save_changes(){
		...
		$this->load->view('menus/right_panel_view', $data);
	}
