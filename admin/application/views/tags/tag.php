...
class Tag extends MX_Controller {
	 ...
	 * @param int $offset
	 */
	public function index($message = 0, $offset = 0){
        	...
        	$per_page = "10";
        	/*** load pagination ***/
			$this->pagination->load_pagination("tag/index/0", 4, $total_rows, $per_page);
			/*** end of pagination ***/
        	...
        	if ($message == 2){
	        	//$data['message'] = $this->lang->line('message_tag_added_successfully');
        	}elseif($message == 3){
	        	$data['message'] = $this->lang->line('message_tag_updated_successfully');
        	}elseif($message == 1){
        	        $data['message'] = $this->lang->line('message_tag_delete_successfully');
        	} 
	...
	public function edit_post(){
		...
		if ($this->form_validation->run() == FALSE){
		        ...
		        //print_r("Insertion successfull!");
		        $this->messages->add('Tag updated successfully!', 'success'); 
		        redirect('tag');
