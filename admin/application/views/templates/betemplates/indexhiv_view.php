...
<div id="position7" class="story-list"><input class="add-module" id="7" type="button" value="+ Add Module" />
</div>   

<br /><br />


<div id="position8" class="story-list"><input class="add-module" id="8" type="button" value="+ Add Module" />
</div>   
